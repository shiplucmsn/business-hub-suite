...
const plans = [
  {
    name: "Free", price: "$0", period: "/month", desc: "For individuals getting started", icon: Zap,
    features: ["1 Website", "5 Products", "Basic Analytics", "Community Support"], current: true,
  },
  {
    name: "Pro", price: "$29", period: "/month", desc: "For growing businesses", icon: Crown, popular: true,
    features: ["5 Websites", "Unlimited Products", "Advanced Analytics", "Priority Support", "Custom Domain", "Service Listings"],
  },
  {
    name: "Business", price: "$99", period: "/month", desc: "For established companies", icon: Building2,
    ...
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
          {plans.map((plan) => (
            <Card key={plan.name} className={`shadow-card border-border/50 relative ${plan.popular ? "ring-2 ring-primary shadow-elevated" : ""}`}>
              {plan.popular && (
              ...
              <CardContent className="p-6 pt-8">
                <div className="rounded-lg bg-secondary p-2 w-fit"><plan.icon className="h-5 w-5 text-primary" /></div>
